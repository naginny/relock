 ...
 */
class Version20180507152632 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE customer_order ADD prepayment_received TINYINT(1) DEFAULT NULL, CHANGE status_id status_id INT DEFAULT NULL, CHANGE customer_id customer_id INT DEFAULT NULL, CHANGE address_id address_id INT DEFAULT NULL, CHANGE closed_at closed_at DATETIME DEFAULT NULL, CHANGE rejected_at rejected_at DATETIME DEFAULT NULL, CHANGE invoice_sent invoice_sent TINYINT(1) DEFAULT NULL, CHANGE invoice_id invoice_id VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE customer_order DROP prepayment_received, CHANGE customer_id customer_id INT DEFAULT NULL, CHANGE status_id status_id INT DEFAULT NULL, CHANGE address_id address_id INT DEFAULT NULL, CHANGE closed_at closed_at DATETIME DEFAULT \'NULL\', CHANGE rejected_at rejected_at DATETIME DEFAULT \'NULL\', CHANGE invoice_sent invoice_sent TINYINT(1) DEFAULT \'NULL\', CHANGE invoice_id invoice_id VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8_unicode_ci');
